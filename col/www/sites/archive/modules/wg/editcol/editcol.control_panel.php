...
IA00001/DDDD.tif
    ...
    <div id="top_tab7" class="tab">
      <ul>
        <li><a href='/admin/config/coll/collexport_settings'>設定匯出CSV欄位</a></li>
        <li><a href='/admin/config/coll/export'>匯出CSV</a></li>
      </ul>
    </div>
